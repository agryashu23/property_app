...
class HotelDataSearch extends SearchDelegate {
  final List<UserHotelModel> filteredHotels;

  HotelDataSearch(this.filteredHotels);
  @override
...
class HomePropertyList extends StatelessWidget {
  final List<UserHotelModel> property;
